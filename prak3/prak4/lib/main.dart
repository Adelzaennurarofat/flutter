...
controller: kelilingLingkaranController, decoration: const InputDecoration (
...
decoration: const InputDecoration( label: Text("Tinggi Tabung"),
...
if (jarijariTabungController.text.isEmpty || tinggiTabungController.text.isEmpty) { ScaffoldMessenger.of (context).showSnackBar(
 const SnackBar(
content: Text(
...
luasSelimutTabungController.text = tabung.getLuasSelimutTabung().toString();

luasPermukaanTabungController.text = tabung.getLuasPermukaanTabung().toString();
...
controller: volumeTabungController, decoration: const InputDecoration(
...
decoration: const InputDecoration( label: Text("Luas Permukaan Tabung"),
...
set setJariJari (jariJari) { _jariJari =jariJari; }
